...
class PythonicJoyCon(JoyCon):
	...
	stick_r       = property(JoyCon.get_button_r_stick)
	...
	l             = property(JoyCon.get_button_l)
	zl            = property(JoyCon.get_button_zl)
	minus         = property(JoyCon.get_button_minus)
	stick_r       = property(JoyCon.get_button_l_stick)
	...
	def accel(self):
		...
		return [
			(self.get_accel_x(0), self.get_accel_y(0) * c, self.get_accel_z(0)) * c,
			(self.get_accel_x(1), self.get_accel_y(1) * c, self.get_accel_z(1)) * c,
			(self.get_accel_x(2), self.get_accel_y(2) * c, self.get_accel_z(2)) * c,
		]
	...
	def accel_in_g(self):
		...
		return [
			(self.get_accel_x(0) * c, self.get_accel_y(0) * c2, self.get_accel_z(0) * c2),
			(self.get_accel_x(1) * c, self.get_accel_y(1) * c2, self.get_accel_z(1) * c2),
			(self.get_accel_x(2) * c, self.get_accel_y(2) * c2, self.get_accel_z(2) * c2),
		]
	...
	def gyro(self):
		c = self._ime_yz_coeff
		return [
			(self.get_gyro_x(0), self.get_gyro_y(0) * c, self.get_gyro_z(0) * c),
			(self.get_gyro_x(1), self.get_gyro_y(1) * c, self.get_gyro_z(1) * c),
			(self.get_gyro_x(2), self.get_gyro_y(2) * c, self.get_gyro_z(2) * c),
		]
	...
	def gyro_in_deg(self):
		...
		c2 = c * self._ime_yz_coeff
		return [
			(self.get_gyro_x(0) * c, self.get_gyro_y(0) * c2, self.get_gyro_z(0) * c2),
			(self.get_gyro_x(1) * c, self.get_gyro_y(1) * c2, self.get_gyro_z(1) * c2),
			(self.get_gyro_x(2) * c, self.get_gyro_y(2) * c2, self.get_gyro_z(2) * c2),
		]
